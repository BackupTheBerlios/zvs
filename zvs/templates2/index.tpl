...
<table width="450" border="0" cellspacing="0" cellpadding="0" class="Box" align="center">
  ...
  <tr>
    ...
    <td width="100%" align="center">
        <p class="SubheadlineYellow"><%if $tpl_status eq 'true'%>Abmelden<%elseif $tpl_status eq 'toggledtrue'%>Abgemeldet<%elseif $tpl_status eq 'toggledfalse'%>Angemeldet<%else%>Anmelden<%/if%><br><%$smarty.now|date_format:"%A, %d. %B %Y %H:%M:%S Uhr"%></p>
		<br>
