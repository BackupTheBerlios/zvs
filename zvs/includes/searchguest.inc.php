...
class SearchGuest extends AjaxACApplication {
    ...
    { 
        ...
        $this->addJsLib('global/search.js'); 
        ...
        require_once('AjaxACWidgetTimer.class.php');
    ...
    {
        require_once('AjaxACWidgetXMLHttpRequest.class.php');
