...
$tpl = "\"Zimmer:\";\"Nachname:\";\"Vorname:\";\"Email:\";\"von:\";\"bis:\";\"Buchungskategorie:\";\"Buchungsstatus:\";\"Erwachsene:\";\"$children0:\";\"$children1:\";\"$children2:\";\"$children3:\";
";

for ($i = 0; $i < count($statarr); $i++) {
    $tpl .= $statarr[$i]['room'] . ";" . $statarr[$i]['lastname'] . ";" . $statarr[$i]['firstname'] . ";" . $statarr[$i]['email'] .";" . $statarr[$i]['startdate'] . ";" . $statarr[$i]['enddate'] . ";" . $statarr[$i]['bookingcat'] . ";" . $statarr[$i]['bookingtype'] . ";" . $statarr[$i]['person'] . ";" . $statarr[$i]['children0'] . ";" . $statarr[$i]['children1'] . ";" . $statarr[$i]['children2'] . ";" . $statarr[$i]['children3'] . ";
";
} 
// show CSV
