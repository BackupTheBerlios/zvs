...
$tpl = "\"Zimmer:\";\"Abreise:\";\"Name:\";\"Ankunft:\";\"Abreise:\";\"Buchungskategorie:\";\"Erwachsene:\";\"$children1:\";\"$children2:\";\"$children3:\";\"Bemerkung\";
";
...
for ($i = 0; $i < count($statarr); $i++) {
    ...
    $tpl .= $statarr[$i]['room'] . ";" . $statarr[$i]['enddate']. ";" . $name . ";" . $statarr[$i]['startdate'] . ";" . $statarr[$i]['enddate2'] . ";" . $statarr[$i]['bookingcat'] . ";" . $statarr[$i]['person'] . ";" . $statarr[$i]['children1'] . ";" . $statarr[$i]['children2'] . ";" . $statarr[$i]['children3'] . ";\"" . $statarr[$i]['addinfo']."\";
";
} 
// show CSV
header("Cache-control: private");
header("Content-type: application/csv");
header("Content-Disposition: attachment; filename=\"roomchange.csv\"");
echo $tpl;
