...
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="Box" align="center">
  ...
  <tr>
	...
	<tr>
		<td class="SubheadlineYellow">Newsletter versenden</td>
		<td align="right"><a href="javascript:document.newsletter.submit();" onClick="unsetaltered();"><img src="<%$wwwroot%>/img/button_email.png" width="82" height="24" border="0" alt="Absenden"></a></td>
	</tr>
	</table>	
