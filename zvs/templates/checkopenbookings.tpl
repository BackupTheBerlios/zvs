...
-->
<title>zvs: Rechnung erstellen</title>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" class="Box" align="center">
  ...
  <tr>
	...
	<%if $tpl_type eq 'bookings'%>
     <p class="SubheadlineYellow">weitere Buchung zur Rechnung hinzuf&uuml;gen</p>
	 <br>
	 <table boder="0" cellspacing="0" cellpadding="0">
	 	<tr>
			...
			<td class="ListL1"><strong>Zimmer</strong></td>
		</tr>
	 ...
	 <%else%>
	     <p class="SubheadlineYellow">zu dieser Buchung gibt es mehrere Rechnungen:</p>
		 <br>	
		 <table boder="0" cellspacing="5" cellpadding="0"> 
			<%section name="r" loop=$tpl_receipts%>
			<tr>
				<td><a href="javascript:openWindow('<%$wwwroot%>receipt.php/receiptid.<%$tpl_receipts[r].receiptid%>/bookid.<%$tpl_bookid%>/guestid.<%$tpl_receipts[r].guestid%>/receipt.php','receipt<%$smarty.section.r.index%>');"><img src="<%$wwwroot%>img/button_rechnung.png" border="0" width="80" height="24" alt="Rechnung"></a></td>
				<td><%$tpl_receipts[r].name%></td>
			</tr>
			<%/section%>
			<%section name="r" loop=$tpl_draftreceipts%>
			<tr>
				<td><a href="javascript:openWindow('<%$wwwroot%>receipt.php/draftreceiptid.<%$tpl_draftreceipts[r].draftreceiptid%>/bookid.<%$tpl_bookid%>/guestid.<%$tpl_draftreceipts[r].guestid%>/receipt.php','receipt<%$smarty.section.r.index%>');"><img src="<%$wwwroot%>img/button_rechnung.png" border="0" width="80" height="24" alt="Rechnung"></a></td>
