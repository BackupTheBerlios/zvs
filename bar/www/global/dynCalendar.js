...
* Last Modified..: $Date: 2004/11/03 15:27:58 $
	...
	function dynCalendar_writeHTML()
	{
		...
		*/
		...
		strDate = eval(this.objName + 'GetValue()');
			...
			document.write('<a href="javascript: ' + this.objName + '.show('+strDate+')"><img src="' + this.imagesPath + 'button_calendar.gif" border="0" width="17" height="15"/></a>');
