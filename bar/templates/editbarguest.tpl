  ...
  <tr>
    ...
    <td width="100%">
		...
		<table border="0">
			<tr>
				<td><b>Vorname:</b></td>
				<td><input type="text" name="frm_firstname" id="frm_firstname" value="<%$tpl_barguest.firstname%>" onKeyPress="submit_onkeypress();"></td>
			</tr>
			<tr>
				<td><b>Nachname:</b></td>
				<td><input type="text" name="frm_lastname" id="frm_lastname" value="<%$tpl_barguest.lastname%>" onKeyPress="submit_onkeypress();"></td>
			</tr>	
			<tr>
