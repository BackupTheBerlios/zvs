		...
		<table border="0">
			...
			<tr>
				...
				<td><select name="frm_bgcat" id="frm_bgcat">
					...
					<option value="<%$tpl_barguestcat[bgcat].barguestcatid%>"><%$tpl_barguestcat[bgcat].barguestcat%></option>
					<%/section%>
				    </select></td>
			</tr>			
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="frm_gcolor" id="frm_gcolor" size="7" maxlength="7" value="#FFFFFF"/><a href="javascript:openWindow();"><img src="<%$wwwroot%>img/button_colorchooser.gif" width="16" height="15" border="0"></a></td>
			<tr>
			<tr>
