		    ...
		    <td width="100%">
				<table border=0 align="center" cellspacing=0 cellpadding=4>
				 <tr valign=top align=left>
				  ...
				  <td align="right"><input type="text" id="username" name="username" value="<%$tpl_login%>" size="32" maxlength="128" onKeyPress="next_onkeypress();"></td>
				 </tr>
				 <tr valign=top align=left>
				  <td><strong>Passwort</strong></td>
				  <td align="right"><input type="password" id="password" name="password" size="32" maxlength="32" onKeyPress="login_onkeypress();" value=""></td>
				 </tr>
