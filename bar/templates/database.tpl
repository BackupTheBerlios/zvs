...
function recover()
{
	...
	if (document.recover.frm_file.value == "")
	{
	  alert('Bitte eine Sicherungsdatei angeben!');
		...
		if (document.recover.frm_schema[document.recover.frm_schema.selectedIndex].value=="zvs_system_bar") {
			schema = "Systemdaten";
		} else {
			schema = "Bardaten";
		}
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="Box" align="center">
  ...
  <tr>
	...
	<tr>
		<td>Bardaten</td>
		<td><a href="<%$wwwroot%>backupdb.php/database.<%$tpl_db%>/backupdb.php"><img src="<%$wwwroot%>img/button_exportdb.png" width="73" height="24" border="0" alt="Bardaten sichern"></a></td>
	</tr>	
	<tr>
		<td>Systemdaten</td>
		<td><a href="<%$wwwroot%>backupdb.php/database.zvs_system_bar/backupdb.php"><img src="<%$wwwroot%>img/button_exportdb.png" width="73" height="24" border="0" alt="Systemdaten sichern"></a></td>
	</tr>
	</table>
		...
		<tr>
			<td>
				<select name="frm_schema" id="frm_schema">
					<option value="<%$tpl_db%>">Bardaten</option>
					<option value="zvs_system_bar">Systemdaten</option>
				</select>
			</td>
			<td>
