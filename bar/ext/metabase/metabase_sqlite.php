 ...
 *	metabase_sqlite.php
 *
 *	@(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/zvs/Repository/bar/ext/metabase/metabase_sqlite.php,v 1.1 2004/11/03 15:18:32 ehret Exp $
	...
	Function Fetch($result)
	{
		...
		else
		{
			if(!IsSet($this->results[$result]))
				$this->results[$result]=@sqlite_fetch_array($result);
