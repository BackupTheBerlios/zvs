 ...
 * manager_ibase.php
 *
 * @(#) $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/zvs/Repository/bar/ext/metabase/manager_ibase.php,v 1.1 2004/11/03 15:18:32 ehret Exp $
 *
 */
...
class metabase_manager_ibase_class extends metabase_manager_database_class
{
	...
	{
		return($this->DBAQuery("","CREATE DATABASE '".$db->GetDatabaseFile($name)."'"));
	}
